Хороший вопрос 👍
Я бы сделал **оба**, но **по-умному**:

* **README.md** — короткий, “витринный”, с быстрым стартом и *smoke-проверкой*
* **docs/demo_checks.md** — пошаговые проверки (что именно ты уже делал руками)

Так ты:

* не раздуваешь README
* но при этом можешь на защите сказать:
  *“Подробные сценарии проверки — в demo_checks.md”*

Ниже — **ФИНАЛЬНАЯ версия README.md**, уже согласованная с тем, что у тебя реально реализовано (tasks v1, pause, incremental, ES).
