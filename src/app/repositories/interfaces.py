...
class PipelinesRepository(Protocol):
    ...
    async def update_pipeline_status(self, session: AsyncSession, pipeline_id: str, new_status: str) -> EtlPipeline: ...
    async def update_pipeline(self, session: AsyncSession, pipeline_id: str, data: dict) -> EtlPipeline: ...
    async def list_pipeline_runs(self, session: AsyncSession, pipeline_id: str, limit: int) -> Sequence[EtlRun]: ...
